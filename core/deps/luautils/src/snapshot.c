...
static const char* keystring(lua_State *L, int index, char * buffer, size_t size) {
...
static void snapshot_gen_result(lua_State *L, lua_State *dL) {
	int count = 0;
