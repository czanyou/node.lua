...
console.log(test)
console.log("get_name", test:get_name())
console.log("get_block_size", test:get_block_size())
console.log("get_cipher_mode", test:get_cipher_mode())
console.log("get_iv_size", test:get_iv_size())
console.log("get_type", test:get_type())
console.log("get_key_bit_len", test:get_key_bit_len())
console.log("get_operation", test:get_operation())
