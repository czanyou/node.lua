...
function update_program()
    ...
    os.execute('wget -P /usr/local/download http://192.168.1.2/node/download/dist/linux/node-lua_i386.deb')
    ...
    str = io.popen('dpkg -i /usr/local/download/node-lua_i386.deb', "r")
    str = str:read("*a")
    console.log(str)
